    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
        <div class="card card-flush shadow-sm">
            <div class="card-header">
                <h3 class="card-title">{{ trans('admin.add_user') }}</</h3>
            </div>
                    ...
                    <div class="tab-pane fade show active" id="kt_tab_pane_4" role="tabpanel">
                        <form action="/{{ app()->getLocale() }}/admin/users/add/" method="post" data-parsley-validate novalidate>
                            ...
                            <div class="form-floating mb-7">
                                <input type="text" name="name" parsley-trigger="change" value="" class="form-control @error('name') danger @enderror" placeholder="" required />
                                @error('name')
                            ...
                            <div class="form-floating mb-7">
                                <input type="email" name="email" parsley-trigger="change" value="" class="form-control @error('email') danger @enderror" placeholder="" required />
                                @error('email')
