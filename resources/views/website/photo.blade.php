        ...
        <div class="photo-gallery section-pad">
            <div class="container">
                <div class="list-section-title flex items-center justify-start mb-1">
                    <h1 class="lemon-medium green ka-font-nino" style="font-size: 26px; line-height: 35px;">PHOTO/VIDEO GALLERY</h1>
                </div>
                ...
                <div class="content">
                    <div class="tab flex items-center justify-center wrap">
                        <button class="tablinks bold text-xl" onclick="openCity(event, 'London')">All</button>
                        <button class="tablinks bold text-xl" onclick="openCity(event, 'Paris')">Paulownia trunk</button>
                        <button class="tablinks bold text-xl" onclick="openCity(event, 'Tokyo')">Biomass and energy</button>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                <div class="photo hidden w-full hover" style="border-radius: 8px;">
                                    <a href="assets/img/post.png" data-fancybox="photo">
                      ...
                      <div id="Paris" class="tabcontent">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                <div class="photo hidden w-full hover" style="border-radius: 8px;">
                                    <a href="assets/img/Mask group.png" data-fancybox="photo">
                      ...
                      <div id="Tokyo" class="tabcontent">
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                <div class="photo hidden w-full hover" style="border-radius: 8px;">
                                    <a href="assets/img/post-image.png" data-fancybox="photo">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                <div class="photo hidden w-full hover" style="border-radius: 8px;">
                                    <a href="assets/img/slider-image.png" data-fancybox="photo">
