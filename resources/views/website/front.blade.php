                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-7 col-md-8 col-sm-12 col-12">
                        ...
                        <div class="text white medium text-xl pr-4">
                            The CropTec business segment has been an integral part of TreeMan for over 12 years in the area of young plant production. Founded in 2009 as a spin-off company of the research area “renewable resources” of the University of Bonn, TreeMan is today considered a European market leader in the field of sustainable Kiri wood production with more than 120 employees.
                            <br><br>
                            Paulownia is a tree with deep roots and a well-developed root system. Upper roots are thin, sharp, branched into two and grow very dense. The intake / absorbing roots are approximately 1-5 mm thick and can extended to more than 60 cm
                        </div>
                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12">
                                <div class="text-block flex items-center justify-start">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="text white pr-4 medium" style="font-size: 18px; line-height: 26px;">
        ...
        <div class="testimonial w-full">
            <div class="container">
                ...
                <div class="text medium text-lg black mb-2">
                    Treeman company produces and provides the best quality Paulovwia tree products, Which are widely used and became a profitable business for our clients.
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="subscribe-info flex column items-start justify-center">
                            ...
                            <div class="text medium white">
                                Learn how to earn big profit from your land.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="subscribe-form w-full flex items-center">
                            <form action="" class="w-full relative">
                                <input type="text" class="w-full medium green" placeholder="E-Mail">
                                <button type="submit" class="semibold text-lg" style="color: #006838">Subscribe</button>
                            </form>
                        </div>
                    </div>
