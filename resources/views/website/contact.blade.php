...
<body>
    <header>
        ...
        <div class="menu-header" style="padding: 27px 0; border-bottom: 1.5px solid RGBA(1,81,78,0.2);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xl-5">
                            <div class="info">
                                ...
                                <div class="contact-info flex column justify-between h-full">
                                    <div class="flex items-center justify-start">
                                        <svg width="20" height="41" viewBox="0 0 20 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.75373 29.2641L12.7625 27.922C13.4 27.7512 14.0295 27.9607 14.4431 28.4111C15.7513 29.8785 17.3167 31.1672 19.1209 32.2089C19.9148 32.6672 20.1893 33.6917 19.731 34.4856L16.8143 39.5374C16.356 40.3312 15.3314 40.6058 14.5376 40.1474C0.984282 32.3224 -3.65814 14.9967 4.16686 1.44338C4.6252 0.649519 5.64971 0.374999 6.44357 0.833333L11.481 3.74167C12.2748 4.2 12.5493 5.22452 12.091 6.01838C11.0577 7.80816 10.338 9.72131 9.93872 11.6462C9.82026 12.2514 9.35702 12.7538 8.74231 12.9185L3.73355 14.2606C3.46811 19.5536 4.86897 24.8273 7.75373 29.2641Z" fill="white"/>
                                        </svg>
                                        <a href="" class="medium text-lg white medium phone transition-duration">
                                            + 995 098 908 986
                                        </a>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-start">
                                        <svg width="30" height="37" viewBox="0 0 30 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15 18.75C16.0312 18.75 16.9144 18.3825 17.6494 17.6475C18.3831 16.9137 18.75 16.0312 18.75 15C18.75 13.9688 18.3831 13.0856 17.6494 12.3506C16.9144 11.6169 16.0312 11.25 15 11.25C13.9688 11.25 13.0863 11.6169 12.3525 12.3506C11.6175 13.0856 11.25 13.9688 11.25 15C11.25 16.0312 11.6175 16.9137 12.3525 17.6475C13.0863 18.3825 13.9688 18.75 15 18.75ZM15 36.7969C14.75 36.7969 14.5 36.75 14.25 36.6562C14 36.5625 13.7812 36.4375 13.5938 36.2812C9.03125 32.25 5.625 28.5081 3.375 25.0556C1.125 21.6019 0 18.375 0 15.375C0 10.6875 1.50813 6.95312 4.52437 4.17188C7.53938 1.39062 11.0312 0 15 0C18.9688 0 22.4606 1.39062 25.4756 4.17188C28.4919 6.95312 30 10.6875 30 15.375C30 18.375 28.875 21.6019 26.625 25.0556C24.375 28.5081 20.9688 32.25 16.4062 36.2812C16.2188 36.4375 16 36.5625 15.75 36.6562C15.5 36.75 15.25 36.7969 15 36.7969Z" fill="white"/>
                                        </svg>
                                        <span class="medium text-lg white medium">
                                            Chavchavadze Str. Tbilisi, Georgia
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 flex wrap">
                                    <div class="flex column items-start w-1_2 pr-1">
                                        <label for="" class="semibold text-lg mb-1 required" style="color: #656C69;">Name</label>
                                        <input type="text" class="w-full pl-1" style="height: 50px;">
                                    </div>

                                    <div class="flex column items-start w-1_2 pl-1">
                                        <label for="" class="semibold text-lg mb-1 required" style="color: #656C69;">E-Mail</label>
                                        <input type="text" class="w-full pl-1" style="height: 50px;">
                                    </div>

                                    <div class="flex column items-start w-1_2 pr-1">
                                        <label for="" class="semibold text-lg mb-1" style="color: #656C69;">Phone</label>
                                        <input type="text" class="w-full pl-1" style="height: 50px;">
                                    </div>

                                    <div class="flex column items-start w-1_2 pl-1">
                                        <label for="" class="semibold text-lg mb-1" style="color: #656C69;">Subject</label>
                                        <input type="text" class="w-full pl-1" style="height: 50px;">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="textarea w-full h-full pl-1">
                                        <label for="" class="semibold text-lg required" style="color: #656C69;">Text</label>
                                        <textarea name="" id="" cols="30" rows="10" class="w-full mt-1 pt-1 pl-1 pr-1 pb-1"></textarea>
                                    </div>
                                </div>

                                <div class="w-full flex items-center justify-end">
                                    <button type="submit" class="flex items-center justify-center white bold text-lg submit-button transition-duration">SEND</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-12">
                            <div class="footer-social flex justify-end items-center">
                                ...
                                <div class="made">
                                    <a href="" class="semibold text-lg white">
                                        Made by Idea Design Group
                                    </a>
                                </div>
                            </div>
                        </div>
