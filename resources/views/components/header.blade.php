                ...
                <div class="flex items-center justify-start">
                    ...
                    <div class="social flex items-center">
                        <div class="icon flex items-center h-full" style="margin: 0 11px;">
                            <a href="{{settings('facebook')}}" class="flex items-center justify-center rounded transition-duration shadow" style="width: 40px; height: 40px;">
                        ...
                        <div class="icon flex items-center h-full" style="margin: 0 11px;">
                            <a href="{{settings('linkedin')}}" class="flex items-center justify-center rounded transition-duration shadow" style="width: 40px; height: 40px;">
                        ...
                        <div class="icon flex items-center h-full" style="margin: 0 11px;">
                            <a href="{{settings('youtube')}}" class="flex items-center justify-center rounded transition-duration shadow" style="width: 40px; height: 40px;">
